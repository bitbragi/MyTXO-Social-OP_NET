...
const MYSCRIBE_LOGO_INSCRIPTION: string = 'aeda9ed5908464fd4e127ed4e29bb5722c14c4558ceb47b5aab49718a3d1fffci0';
const MYSCRIBE_BANNER_INSCRIPTION: string = '6e0d0ab53308f20a98c8536e03f02c00e094512b74eb240727b275513cf9aa1ai0';
...
/**
 * MyScribeProfile — Per-user OP721 profile contract.
 *
 ...
 *
 * Deployed per-user. Registered with MyScribeFactory for username resolution.
 */
@final
export class MyScribeProfile extends OP721 {
    ...
    public override onDeployment(calldata: Calldata): void {
        ...
        const baseURI: string = 'https://myscribe.org/api/nft/' + username + '/';
        const collectionIcon: string = avatarInscId.length > 0
            ? ORDINALS_CONTENT + avatarInscId
            : ORDINALS_CONTENT + MYSCRIBE_LOGO_INSCRIPTION;
        const collectionBanner: string = ORDINALS_CONTENT + MYSCRIBE_BANNER_INSCRIPTION;
        this.instantiate(new OP721InitParameters(
            ...
            collectionIcon,
            'https://myscribe.org',
            (displayName.length > 0 ? displayName : username) + "'s MyScribe Profile",
        ));
